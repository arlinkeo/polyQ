...
# labeledHeatmap(as.matrix((table1 > 0) + 0), xLabels = colnames(table1), yLabels = rownames(table1),
...
# par(mai = c(0.5, 2, 3, 0.5));
# labeledHeatmap(table2a, xLabels = colnames(table2b), yLabels = rownames(table2b),
